...
export const FIELD_TYPES: Record<FieldType, FieldTypeMeta> = {
  ...
  slider: { type: 'slider', category: 'standard', label: 'Slider', description: 'Pick a number on a min–max range', scoring: false, valueKind: 'number' },
  ...
  gps: { type: 'gps', category: 'standard', label: 'Location (GPS)', description: 'Capture the device location', scoring: false, valueKind: 'compound' },
  ...
  rich_text: { type: 'rich_text', category: 'standard', label: 'Rich text', description: 'Formatted text — bold, lists, links', scoring: false, valueKind: 'string' },
  address: { type: 'address', category: 'standard', label: 'Address', description: 'Postal address with autocomplete', scoring: false, valueKind: 'compound' },
  qr_scanner: { type: 'qr_scanner', category: 'standard', label: 'QR / barcode scan', description: 'Scan a QR code or barcode with the camera', scoring: false, valueKind: 'string' },
  ...
  ranking: { type: 'ranking', category: 'choice', label: 'Ranking', description: 'Drag options into a ranked order', scoring: false, valueKind: 'string_array' },
  ...
  matrix: { type: 'matrix', category: 'scoring', label: 'Rating grid', description: 'Rate each row on a shared scale (Likert)', scoring: true, valueKind: 'compound' },
  ...
  photo_ai: { type: 'photo_ai', category: 'media', label: 'Photo + AI analysis', description: 'Capture a photo and flag missing PPE / hazards with AI', scoring: false, valueKind: 'compound' },
  photo_annotated: { type: 'photo_annotated', category: 'media', label: 'Photo + markup', description: 'Capture a photo and drop numbered markers on hazards', scoring: false, valueKind: 'compound' },
  ...
  // data-bound
  lookup: { type: 'lookup', category: 'data', label: 'Lookup', description: 'Pick a record from a data source — can auto-fill other fields', scoring: false, valueKind: 'string' },
  data_table: { type: 'data_table', category: 'data', label: 'Data table', description: 'Show or select rows from a data source', scoring: false, valueKind: 'string_array' },
  metric: { type: 'metric', category: 'data', label: 'KPI / chart', description: 'A live number or chart aggregated from a data source', scoring: false, valueKind: 'none' },
