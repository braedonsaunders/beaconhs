...
export const REPORT_ENTITIES: ReportEntity[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { key: 'requires_annual_inspection', label: 'Requires annual inspection', kind: 'enum' },
  ...
  },
  {
    ...
    category: 'equipment',
    description:
      'Imported source-neutral work activity facts used to assist vehicle log entry and reporting.',
    table: 'report_work_activity',
    columns: [
      { key: 'activity_date', label: 'Activity date', kind: 'date' },
      { key: 'month', label: 'Month', kind: 'date' },
      { key: 'employee_no', label: 'Employee #', kind: 'text' },
      { key: 'external_employee_id', label: 'External employee ID', kind: 'text' },
      { key: 'person_name', label: 'Person', kind: 'text' },
      { key: 'site_code', label: 'Site code', kind: 'text' },
      { key: 'site_name', label: 'Site', kind: 'text' },
      { key: 'source_code', label: 'Source code', kind: 'text' },
      { key: 'source_label', label: 'Source label', kind: 'text' },
      { key: 'source_system', label: 'Source system', kind: 'text' },
      { key: 'source_name', label: 'Source name', kind: 'text' },
