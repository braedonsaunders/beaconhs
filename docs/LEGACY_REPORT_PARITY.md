...
| Inspections — Completed                    | Report: **Inspections — Completed**                    | Date range; native inspection records grouped by inspection type with their recorded location                          | Preview, CSV, Excel, PDF, email, schedule | ✅                                                         |
