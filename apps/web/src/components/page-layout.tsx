...
export function ListPageLayout({
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      <div className="border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-6 pt-4 pb-3">
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      ...
      <div className="flex min-h-0 flex-1 overflow-hidden">
        <aside className="app-scroll w-72 shrink-0 overflow-y-auto border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6">
          {sidebar}
        </aside>
