...
export function PageContainer({
  ...
  return (
    <div className="app-scroll flex-1 overflow-y-auto">
      <div className={cn('mx-auto w-full max-w-screen-2xl p-6', className)}>{children}</div>
    </div>
  )
}
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      <div className="border-b border-slate-200 bg-white px-6 pb-3 pt-5">
        <div className="mx-auto max-w-screen-2xl space-y-3">{header}</div>
      </div>
...
export function DetailPageLayout({
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      ...
      <div className="app-scroll min-h-0 flex-1 overflow-y-auto">
        <div className={cn('mx-auto max-w-screen-2xl p-6', className)}>{children}</div>
      </div>
    </div>
  )
}
...
export function WizardLayout({
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      <div className="border-b border-slate-200 bg-white">
        <div className="mx-auto max-w-2xl px-6 py-4">{header}</div>
      </div>
      <div className="app-scroll min-h-0 flex-1 overflow-y-auto">
