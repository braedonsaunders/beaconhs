  ...
  return (
    <div className="flex shrink-0 items-center gap-2 border-b border-rose-300 bg-rose-50 px-4 py-1.5 text-xs text-rose-900 sm:px-6 dark:border-rose-800/60 dark:bg-rose-950/40 dark:text-rose-200">
      ...
      <span className="truncate">
        <GeneratedText id="m_0f75c15223ccfc" />{' '}
        <strong>
          <GeneratedValue value={targetName} />
        </strong>
        <span className="hidden text-rose-700/90 sm:inline dark:text-rose-300/80">
          <GeneratedValue value={' '} />
          <GeneratedText id="m_0be9305a14b76a" /> <GeneratedValue value={actorName} />
        </span>
      </span>
      <span className="ml-auto flex shrink-0 items-center gap-3">
        <GeneratedValue
          value={
            countdown ? (
              <span className="text-rose-700 tabular-nums dark:text-rose-300/80">
                <GeneratedValue value={countdown} />
              </span>
            ) : null
          }
        />
