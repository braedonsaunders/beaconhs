  ...
  return (
    <div className={cn('flex min-h-0 flex-col', className)}>
      ...
      >
        ...
        <Button type="button" variant="ghost" size="sm" disabled={!selected} onClick={deleteSlide}>
            ...
            {showImport ? (
              <div className="rounded-lg border border-slate-200 bg-white p-3 dark:border-slate-800 dark:bg-slate-900">
                <FileUploader
                  ...
                  hint="Each page arrives as a slide you can annotate (speaker notes preserved)."
                />
              </div>
            ) : null}
            {selected ? (
