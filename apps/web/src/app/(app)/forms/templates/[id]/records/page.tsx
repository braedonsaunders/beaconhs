...
// (/forms/responses/[id]). New entries are created via the filler; editors get
...
export default async function AppRecordsPage({
  ...
  const basePath = `/forms/templates/${id}/records`
  const newHref = `/forms/templates/${id}/fill`
        ...
        <>
          <PageHeader
            ...
            actions={
              <>
                {canConfigure ? (
                  <Link href={`/forms/templates/${id}/designer`}>
                ...
                return (
                  <TableRow key={response.id}>
                    <TableCell className="font-mono text-xs">
                      <Link
                        href={`/forms/templates/${id}/fill?responseId=${response.id}`}
