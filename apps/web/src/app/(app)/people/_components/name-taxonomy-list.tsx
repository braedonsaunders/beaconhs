    ...
    <ListPageLayout
      header={
        <>
          ...
          />
          <SearchInput
            placeholder={tGenerated('m_15e71b3fa83632', { value0: title.toLowerCase() })}
          />
        </>
      }
    >
          ...
          rows.length === 0 ? (
            <EmptyState
              title={tGeneratedValue(
                params.q
                  ? tGenerated('m_1e427322713637', {
                      value0: title.toLowerCase(),
                      value1: params.q,
                    })
                  : tGenerated('m_0aa12bd81055e4', { value0: title.toLowerCase() }),
              )}
              ...
              action={
                params.q ? undefined : (
                  <Link href={newHref as never} scroll={false}>
                    <Button>
                      <GeneratedText id="m_16c8592e5020a4" /> <GeneratedValue value={noun} />
                    </Button>
                  </Link>
                )
              }
                            ...
                            <div className="inline-flex items-center gap-1">
                              ...
                              <form action={deleteAction} className="inline">
                                ...
                                <button
                                  ...
                                  title={tGeneratedValue(
                                    r.memberCount > 0
                                      ? tGenerated('m_090cc39a8b9b3d', { value0: r.memberCount })
