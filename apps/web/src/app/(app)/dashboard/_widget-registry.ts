...
export const WIDGETS: Record<string, WidgetMeta> = {
  ...
  'personal-my-equipment': {
    ...
    category: 'personal',
    label: 'My equipment',
    description: 'Checked-out equipment plus a shortcut to inspect any registered or rental unit.',
    defaultSize: { w: 6, h: 5 },
    minSize: { w: 3, h: 4 },
  },
  'personal-my-compliance': {
    ...
    category: 'personal',
    label: 'My compliance',
    description: 'Current-period recurring work with one-time documents summarized separately.',
    defaultSize: { w: 6, h: 5 },
    minSize: { w: 3, h: 4 },
  },
  'personal-inbox': {
