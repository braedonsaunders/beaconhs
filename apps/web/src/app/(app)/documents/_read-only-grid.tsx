...
// Read-only documents library for users without `documents.manage`. A
// responsive card grid; each card opens the dedicated reader page (published
// PDF + self-acknowledge). No edit affordances.
        ...
        value={docs.map((d) => (
          ...
          >
            ...
            <span className="mt-auto inline-flex items-center gap-1.5 pt-4 text-xs font-semibold text-teal-600 group-hover:gap-2 dark:text-teal-400">
              <FileText size={13} /> <GeneratedText id="m_0431e4b7409595" />
            </span>
          </Link>
        ))}
      />
