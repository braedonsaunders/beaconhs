    ...
    <ListPageLayout
      header={
        <>
          <PageHeader
            ...
            actions={
              <div className="flex items-center gap-2">
                <Link href={buildExportHref('/confined-space/export.csv', sp)}>
          ...
          />
          <ConfinedSpaceSubNav active="permits" />
          <TableToolbar>
    ...
    >
      {rows.length === 0 ? (
        <EmptyState
          ...
          title={params.q || statusFilter ? 'No permits match these filters' : 'No permits'}
