// Timezone-aware datetime helpers for the equipment-inspections runtime.
//
...
// the posted wall-clock string back into an instant in that same zone. Same
// approach as the hazard-assessments module's datetime helpers.
