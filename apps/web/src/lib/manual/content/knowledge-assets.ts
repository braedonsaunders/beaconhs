...
- **Normalize page content** matches the body text size across documents, so type stops changing between them, and centres each document so the margins match too. Leave this on for a manual.
