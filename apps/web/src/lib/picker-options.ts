...
export const PICKER_LOOKUPS = [
  ...
  'notification-group-people',
  'notification-group-roles',
  'notification-group-departments',
  'notification-group-org-units',
  'notification-group-trades',
  'notification-group-crews',
  'notification-group-person-groups',
