...
describe('cron scheduling', () => {
  ...
  it('uses Vixie OR semantics when day-of-month and day-of-week are restricted', () => {
    ...
    expect(cronOccursAt(expression, new Date('2026-07-13T09:00:00.000Z'))).toBe(true)
    expect(cronOccursAt(expression, new Date('2026-07-20T09:00:00.000Z'))).toBe(true)
    expect(cronOccursAt(expression, new Date('2026-08-13T09:00:00.000Z'))).toBe(true)
